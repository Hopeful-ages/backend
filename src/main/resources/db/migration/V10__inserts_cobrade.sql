...
ALTER TABLE cobrade ALTER COLUMN subgroup TYPE VARCHAR(250);
ALTER TABLE cobrade ALTER COLUMN type TYPE VARCHAR(500);
ALTER TABLE cobrade ALTER COLUMN subtype TYPE VARCHAR(500);
...
('1.3.3.1.0', 'Temperaturas extremas', 'Onda de calor', NULL, 'É um período prolongado de tempo excessivamente quente e desconfortável, onde as temperaturas ficam acima de um valor normal esperado para aquela região em determinado período do ano. Geralmente adotado um período mínimo de três dias com temperaturas $5^{\circ}C$ acima dos valores máximos médios.'),
('1.3.3.2.1', 'Temperaturas extremas', 'Onda de frio', 'Friagem', 'Período de tempo que dura, no mínimo, de três a quatro dias, e os valores de temperatura mínima do ar ficam abaixo dos valores esperados para determinada região em um período do ano.'),
('1.3.3.2.2', 'Temperaturas extremas', 'Onda de frio', 'Geadas', 'Formação de uma camada de cristais de gelo na superfície ou na folhagem exposta.'),
-- 4. CLIMATOLÓGICO
('1.4.1.1.0', 'Seca', 'Estiagem', NULL, 'Período prolongado de baixa ou nenhuma pluviosidade, em que a perda de umidade do solo é superior à sua reposição.'),
...
('1.4.1.3.1', 'Incêndio florestal', 'Incêndios em parques, áreas de proteção ambiental e áreas de preservação permanente nacionais, estaduais ou municipais', NULL, 'Propagação de fogo sem controle, em qualquer tipo de vegetação situada em áreas legalmente protegidas.'),
('1.4.1.3.2', 'Incêndio florestal', 'Incêndios em áreas não protegidas, com reflexos na qualidade do ar', NULL, 'Propagação de fogo sem controle, em qualquer tipo de vegetação que não se encontre em áreas sob proteção legal, acarretando queda da qualidade do ar.'),
('1.4.1.4.0', 'Climatológico', 'Baixa umidade do ar', NULL, 'Queda da taxa de vapor de água suspensa na atmosfera para níveis abaixo de 20%.'),
-- 5. BIOLÓGICO
...
('1.5.1.3.0', 'Epidemias', 'Doenças infecciosas parasiticas', NULL, 'Aumento brusco, significativo e transitório da ocorrência de doenças infecciosas geradas por parasitas.'),
...
('1.5.2.1.0', 'Infestações/Pragas', 'Infestações de animais', NULL, 'Infestações por animais que alterem o equilíbrio ecológico de uma região, bacia hidrográfica ou bioma afetado por suas ações predatórias.'),
('1.5.2.2.1', 'Infestações/Pragas', 'Infestações de algas', 'Marés vermelhas', 'Aglomeração de microalgas em água doce ou em água salgada suficiente para causar alterações físicas, químicas ou biológicas em sua composição, caracterizada por uma mudança de cor, tornando-se amarela, laranja, vermelha ou marrom.'),
('1.5.2.2.2', 'Infestações/Pragas', 'Infestações de algas', 'Cianobactérias em reservatórios', 'Aglomeração de cianobactérias em reservatórios receptores de descargas de dejetos domésticos, industriais e/ou agrícolas, provocando alterações das propriedades físicas, químicas ou biológicas da água.'),
