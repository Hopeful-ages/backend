...
-- Movimento de massa
('1.1.3.1.1', 'Movimento de massa', 'Quedas, tombamentos e rolamentos', 'Blocos', 
'As quedas de blocos são movimentos rápido se acontecem quando materiais rochosos diversos 
e de volumes variáveis se destacam de encostas muito íngremes, num movimento tipo queda livre. 
Os tombamentos de blocos são movimentos de massa em que ocorre rotação de um bloco de solo ou rocha em torno 
de um ponto ou abaixo do centro de gravidade da massa desprendida.
Rolamentos de blocos são movimentos de blocos rochosos ao longo de encostas, que 
ocorrem geralmente pela perda de apoio(descalçamento).'),
...
('1.1.3.2.1', 'Movimento de massa', 'Deslizamentos', 'Deslizamentos de solo e/ou rocha', 'São movimentos rápidos de solo ou rocha, apresentando superfície de ruptura bem definida, de duração relativamente curta, de massas de terreno geralmente bem definidas quanto ao seu volume, 
cujo centro de gravidade se desloca para baixo e para fora do talude. 
Frequentemente, os primeiros sinais desses movimentos são a presença de fissuras.'),
...
('1.3.1.1.2', 'Sistemas de grande escala/Escala regional', 'Ciclones', 'Marés de tempestade (ressaca)', 'Ondas violentas geradas por ventos fortes que elevam o nível do oceano, causando inundação costeira, aumento das ondas e destruição de infraestruturas litorâneas. 
e essa intensificação das correntes marítimas carrega uma enorme quantidade de água em direção ao litoral. Em consequência, as praias inundam, as ondas se tornam maiores e a orla pode ser devastada alagando ruas e destruindo edificações.'),
...
('1.3.2.1.1', 'Tempestades', 'Tempestade local/Convectiva', 'Tornados', 'Coluna de ar que gira de forma violenta emuito perigosa, 
estando em contato com a terra e a base de uma nuvem de grande desenvolvimento vertical. 
Essa coluna de ar pode percorrer vários quilômetros e deixa um rastro de destruição pelo caminho percorrido.'),
...
('1.3.2.1.4', 'Tempestades', 'Tempestade local/Convectiva', 'Chuvas intensas', 'São chuvas que ocorrem com acumulados significativos, 
causando múltiplos desastres (ex.: inundações, movimentos de massa, enxurradas, etc.).'),
